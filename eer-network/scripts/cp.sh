cp ./organizations/peerOrganizations/org1.example.com/connection-org1.yaml ./../node-tests/gateway/
cp ./organizations/peerOrganizations/org2.example.com/connection-org2.yaml ./../node-tests/gateway/

cp ./organizations/peerOrganizations/org1.example.com/connection-org1.yaml ./../go-tests/gateway/
cp ./organizations/peerOrganizations/org2.example.com/connection-org2.yaml ./../go-tests/gateway/
